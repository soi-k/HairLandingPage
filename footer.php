...
<?php
$insta = hair_mod('contact_instagram', '');
$wa    = hair_mod('contact_whatsapp', '');
if ($insta || $wa) : ?>
<div class="social-float">
  <?php if ($wa) : ?>
  <a href="<?php echo esc_url($wa); ?>" class="social-float-btn social-float-wa"
  ...
  <?php endif; ?>
  <?php if ($insta) : ?>
  <a href="<?php echo esc_url($insta); ?>" class="social-float-btn social-float-ig"
